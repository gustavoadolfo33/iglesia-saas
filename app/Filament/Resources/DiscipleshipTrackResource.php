...
use App\Filament\Resources\DiscipleshipTrackResource\Pages;
...
class DiscipleshipTrackResource extends Resource
{
    protected static ?string $model = DiscipleshipTrack::class;

    protected static ?string $navigationIcon = 'heroicon-o-academic-cap';
    protected static ?string $navigationGroup = 'Seguimiento pastoral';
    protected static ?string $navigationLabel = 'Rutas de discipulado';
    ...
    {
        return [
            'index' => Pages\ListDiscipleshipTracks::route('/'),
            'create' => Pages\CreateDiscipleshipTrack::route('/create'),
            'edit' => Pages\EditDiscipleshipTrack::route('/{record}/edit'),
        ];
    }
}
