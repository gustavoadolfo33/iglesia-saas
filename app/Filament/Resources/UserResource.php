...
class UserResource extends Resource
{
    ...
    public const GLOBAL_PERMISSION_LABELS = [
        ...
        'formacion.view' => 'Ver formacion',
        'formacion.courses.manage' => 'Gestionar cursos',
        'formacion.teachers.manage' => 'Gestionar docentes',
        'formacion.enrollments.manage' => 'Gestionar inscripciones',
        'formacion.progress.manage' => 'Gestionar progreso',
